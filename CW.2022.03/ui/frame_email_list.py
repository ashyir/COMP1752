...
class EmailListFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        btn_add_label.grid(row=0, column=4, padx=(5, 0), sticky="ew")

        # Second row with list of emails.
        self.email_list = ttk.Treeview(self, columns=self.columns, show="headings")
        self.email_list.grid(row=1, column=0, columnspan=5, pady=10, sticky="nsew")
        ...
        btn_logout.grid(row=2, column=4, sticky="e")
